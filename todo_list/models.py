...
class WV_Daily_Report_Details(models.Model):
    ...
    PU_Kg= models.CharField(max_length=200, null=False)
    PU_PKR = models.CharField(max_length=200, null=False)
    Volume_L = models.CharField(max_length=200, null=False)
    Volume_W = models.CharField(max_length=200, null=False)
    Volume_H = models.CharField(max_length=200, null=False)
    Volume = models.CharField(max_length=200, null=False)
    AREA = models.CharField(max_length=200, null=False)
    Progress = models.CharField(max_length=200)
    Cement = models.CharField(max_length=200, null=False)
    Rebar_Qty = models.CharField(max_length=200, null=False)
    Rebar_Length = models.CharField(max_length=200, null=False)
    Rebar_Size = models.CharField(max_length=200, null=False)
    created_date = models.DateTimeField(auto_now_add=True)
    modified_date = models.DateTimeField(auto_now=True)
    Is_Active = models.BooleanField(default=True)
